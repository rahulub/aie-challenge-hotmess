...
;
const metadata = {
    // <CHANGE> Updated metadata for Hot Mess Coach
    title: "Hot Mess Coach - Thanksgiving Survival Guide",
    description: "Your chaotic Thanksgiving survival coach - dealing with family drama, cooking disasters, and holiday stress with AI-powered support",
    generator: "v0.app",
    icons: {
        icon: [
            {
